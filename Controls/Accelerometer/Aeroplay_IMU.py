...
while True:
    ...
    if (currentTime - lastBoost <= 10000):
        boost = -1
    ...
    csvString = f"{round(accXnorm,4)},{round(accYnorm,4)},{round(accZnorm,4)},{boost}"
    
    client.publish("ece180d/team3", csvString,qos=1)

    time.sleep(1 / samplingFreq)
